			...
			<Layout route={current_route} breadcrumb={breadcrumb}>
				<div className="container-fluid py-4">
					<div className="row gap-2">
						<div className="col-xl-3 col-sm-60">
							<div className="card">
					...
					<div className="row gap-2 mt-3 mt-lg-5">
										...
										<li className="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg" key={index}>
											<div className="d-flex align-items-center">
												...
												<div className="d-flex flex-column">
													...
													<span className="text-xs">{item.formatted_start}, <span className="font-weight-bold">346+</span> participants</span>
												</div>
											</div>
											<div className="d-flex">
												<Link href={`/meetings/${item.id}`} className="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
													<FiChevronRight />
												</Link>
											</div>
										</li>
									...
									<ul className="list-group">
										...
										<li className="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg" key={index}>
											<div className="d-flex align-items-center">
												...
												<div className="d-flex flex-column">
													<h6 className="mb-1 text-dark text-sm">{item.name}</h6>
													<span className="text-xs"><span className="font-weight-bold">346+</span> participants</span>
												</div>
											</div>
											<div className="d-flex">
												<Link href={`/meetings/${item.id}`} className="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
